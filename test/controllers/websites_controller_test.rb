...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { logo: @website.logo, mainimage: @website.mainimage, subheading: @website.subheading, title: @website.title } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { logo: @website.logo, mainimage: @website.mainimage, subheading: @website.subheading, title: @website.title } }
