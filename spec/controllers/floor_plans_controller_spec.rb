...
RSpec.describe FloorPlansController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all floor_plans as @floor_plans" do
      floor_plan = FloorPlan.create! valid_attributes
  ...
  describe "GET #show" do
    it "assigns the requested floor_plan as @floor_plan" do
      floor_plan = FloorPlan.create! valid_attributes
      get :show, params: {id: floor_plan.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested floor_plan as @floor_plan" do
      floor_plan = FloorPlan.create! valid_attributes
      get :edit, params: {id: floor_plan.to_param}, session: valid_session
      expect(assigns(:floor_plan)).to eq(floor_plan)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new FloorPlan" do
        expect {
          post :create, params: {floor_plan: valid_attributes}, session: valid_session
      ...
      it "redirects to the created floor_plan" do
        post :create, params: {floor_plan: valid_attributes}, session: valid_session
        expect(response).to redirect_to(FloorPlan.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved floor_plan as @floor_plan" do
        post :create, params: {floor_plan: invalid_attributes}, session: valid_session
        expect(assigns(:floor_plan)).to be_a_new(FloorPlan)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested floor_plan" do
        floor_plan = FloorPlan.create! valid_attributes
        put :update, params: {id: floor_plan.to_param, floor_plan: new_attributes}, session: valid_session
        floor_plan.reload
      ...
      it "assigns the requested floor_plan as @floor_plan" do
        floor_plan = FloorPlan.create! valid_attributes
        put :update, params: {id: floor_plan.to_param, floor_plan: valid_attributes}, session: valid_session
        expect(assigns(:floor_plan)).to eq(floor_plan)
      end

      it "redirects to the floor_plan" do
        floor_plan = FloorPlan.create! valid_attributes
        put :update, params: {id: floor_plan.to_param, floor_plan: valid_attributes}, session: valid_session
        expect(response).to redirect_to(floor_plan)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the floor_plan as @floor_plan" do
        floor_plan = FloorPlan.create! valid_attributes
        put :update, params: {id: floor_plan.to_param, floor_plan: invalid_attributes}, session: valid_session
        expect(assigns(:floor_plan)).to eq(floor_plan)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested floor_plan" do
      floor_plan = FloorPlan.create! valid_attributes
      expect {
        delete :destroy, params: {id: floor_plan.to_param}, session: valid_session
      }.to change(FloorPlan, :count).by(-1)
    end
    ...
    it "redirects to the floor_plans list" do
      floor_plan = FloorPlan.create! valid_attributes
      delete :destroy, params: {id: floor_plan.to_param}, session: valid_session
      expect(response).to redirect_to(floor_plans_url)
    end
  end
