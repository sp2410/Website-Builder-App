...
RSpec.describe "previous_owners/new", type: :view do
  before(:each) do
    assign(:previous_owner, PreviousOwner.new(
      :name => "MyString",
  ...
  it "renders new previous_owner form" do
    render

    assert_select "form[action=?][method=?]", previous_owners_path, "post" do
