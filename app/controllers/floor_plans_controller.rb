class FloorPlansController < ApplicationController
  ...
  private
    ...
    def floor_plan_params
      params.require(:floor_plan).permit(:floor_planned, :amount_floor_planned, :date_opened, :percentcharged, :admin_fee, :setup_fee, :additional_fee, :length_of_floor_plan, :days_untill_firstcurtailment, :days_untill_secondcurtailment, :days_untill_third_curtailment, :company_name, :company_contact, :total)
    end
end
